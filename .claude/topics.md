# Potty Pal Blog Topics Queue

Status legend: `[ ]` = available, `[x]` = published, `[~]` = in progress
...
- [x] Potty Training and UTIs: What Every Parent Should Know
...
- [x] Night Training Hacks: Waterproof Mattress Setups That Actually Work

## Special Situations
- [x] Potty Training on an Airplane: A Survival Guide
...
- [x] Potty Training a Shy or Anxious Child
